...
import com.bw.ddvs.observerpattern01.bean.EventType;
    ...
    public void update(Observable observable, Object data) {
        if (data instanceof String) {
            ...
            if (EventType.RESPONSE_SUCESS.equals(message)) {
                image.setBackgroundResource(R.mipmap.btn_yes_pressed);

            } else if (EventType.RESPONSE_FAIL.equals(message)) {
                image.setBackgroundResource(R.mipmap.ic_btn_actionmenu_cancel_pressed);
            }
        }
    }
}
